...
% dlmwrite(outfile_silent,rf_silent,'delimiter','\n');
...
%% deposit fitness data: table format
%single codon subsitutiton: mutation, relative fitness (0,10,40,100pM)
%single amino acid subsitutiton: mutation, relative fitness (0,10,40,100pM)
